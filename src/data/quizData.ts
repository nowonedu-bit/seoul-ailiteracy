...
export const locations: Location[] = [
  {
    ...
    goodQuiz: {
      ...
      correctIndex: 0,
      explanation: "인공지능은 우리가 말이나 글로 설명한 복잡한 생각을 순식간에 그림으로 만들어 주어, 표현하고 싶은 것을 마음껏 나타낼 수 있게 도와줘요.",
    ...
    badQuiz: {
      ...
      correctIndex: 1,
      explanation: "인공지능은 수많은 화가의 그림을 공부해서 결과물을 만들어요. 이 과정에서 원래 그린 사람의 노력을 무시하고 허락 없이 스타일을 흉내 낼 수 있어 조심해야 해요.",
  ...
  },
  {
    ...
    goodQuiz: {
      ...
      correctIndex: 2,
      explanation: "인공지능이 나의 취향을 분석해 맞춤형 영상을 골라주기 때문에, 수많은 정보 중에서 나에게 필요한 즐거움을 빠르게 찾을 수 있도록 도와줍니다.",
    ...
    badQuiz: {
      ...
      correctIndex: 0,
      explanation: "인공지능은 우리가 좋아하는 것만 계속 보여주기 때문에, 다른 사람의 다양한 생각을 만날 기회를 방해해요. 마치 음식만 편식하듯 '생각의 편식'을 하게 될 수 있어요.",
  ...
  },
  {
    ...
    goodQuiz: {
      ...
      correctIndex: 1,
      explanation: "다른 나라 말을 우리말로, 우리 말을 외국어로 즉시 바꿔주어 언어의 벽을 넘어 전 세계 친구들과 마음을 나눌 수 있게 해줘요.",
    ...
    badQuiz: {
      ...
      correctIndex: 2,
      explanation: "기계에만 의존하다 보면 스스로 새로운 언어를 배우고 익히는 즐거움을 잊어버리고, 기계가 없으면 대화조차 할 수 없게 될 수 있어요.",
  ...
  },
  {
    ...
    goodQuiz: {
      ...
      correctIndex: 1,
      explanation: "선생님이 곁에 없어도 궁금한 것을 물어보면 밤낮 상관없이 언제든 친절하게 가르쳐주어 부족한 공부를 스스로 채울 수 있게 도와줘요.",
    ...
    badQuiz: {
      ...
      correctIndex: 2,
      explanation: "문제를 해결하는 과정은 생각하지 않고 인공지능이 주는 답만 받아 적다 보면, 정작 우리 스스로 문제를 풀 수 있는 능력은 점점 사라지게 돼요.",
  ...
  },
  {
    ...
    goodQuiz: {
      ...
      correctIndex: 2,
      explanation: "식판 사진을 찍어 내가 어떤 영양소를 얼마나 먹었는지 확인하고, 부족한 영양소를 채울 수 있는 건강한 음식을 골라줘서 튼튼하게 자라도록 도와줘요.",
    ...
    badQuiz: {
      ...
      correctIndex: 0,
      explanation: "사진 데이터가 처리되는 과정에서 내 소중한 정보가 다른 곳으로 빠져나갈 수 있고, 내가 무엇을 먹는지 누군가 훔쳐볼 수도 있어 조심해야 해요.",
  ...
  },
  {
    ...
    goodQuiz: {
      ...
      correctIndex: 1,
      explanation: "인공지능은 감정에 치우치지 않고 아주 빠른 움직임도 정확히 잡아내기 때문에, 억울한 판정 없이 누구나 인정할 수 있는 깨끗한 경기를 만들어줘요.",
    ...
    badQuiz: {
      ...
      correctIndex: 0,
      explanation: "인공지능도 기계적인 오류나 프로그램의 실수로 잘못된 판단을 할 수 있어요. 하지만 인공지능은 스스로 책임을 질 수 있는 사람이 아니기 때문에, 판정이 틀렸을 때 누가 사과를 하고 결과를 고쳐야 하는지 책임의 대상이 확실하지 않다는 문제가 있어요.",
